export const manifest = {
  screens: {
    ...
    scr_fni23m: { name: "Character Library · Grid", route: "/app/library", state: { "view": "grid" }, position: { "x": 160, "y": 6160 } },
    scr_ubqky6: { name: "Character Library · List", route: "/app/library", state: { "view": "list" }, position: { "x": 2960, "y": 6160 } },
    ...
    scr_v10ti5: { name: "Settings · Workspace", route: "/app/settings", state: { "tab": "workspace" }, position: { "x": 1560, "y": 12100 } },
    scr_64q2id: { name: "Settings · Notifications", route: "/app/settings", state: { "tab": "notifications" }, position: { "x": 4360, "y": 12100 } },
    scr_2lxzvq: { name: "Settings · Accessibility", route: "/app/settings", state: { "tab": "accessibility" }, position: { "x": 5760, "y": 12100 } },
    scr_ell4r6: { name: "Settings · Security", route: "/app/settings", state: { "tab": "security" }, position: { "x": 7160, "y": 12100 }, width: 1333, height: 800 },
    scr_zwax5u: { name: "Help Centre", route: "/app/help", position: { "x": 2960, "y": 12100 } },
    scr_mvcrwb: { name: "Admin Dashboard Analytics", route: "/admin/dashboard", position: { "x": 160, "y": 14080 }, width: 1351, height: 1210 },
    ...
    scr_a1wnil: { name: "Admin Settings · Organisation", route: "/admin/settings", state: { "tab": "organisation" }, position: { "x": 7160, "y": 14080 } },
    scr_ld8juj: { name: "Admin Settings · Governance", route: "/admin/settings", state: { "tab": "governance" }, position: { "x": 8560, "y": 14080 } },
    scr_aj1815: { name: "Admin Settings · Integrations", route: "/admin/settings", state: { "tab": "integrations" }, position: { "x": 9960, "y": 14080 } }
  },
  sections: {
    ...
    sec_pemdf2: { name: "Character Management", x: 0, y: 5940, width: 4320, height: 1180 },
    sec_qpypwe: { name: "Viewer", x: 0, y: 7920, width: 4320, height: 1180 },
    sec_fwr4q2: { name: "Export", x: 0, y: 9900, width: 1520, height: 1180 },
    sec_k017nt: { name: "User Settings", x: 0, y: 11880, width: 8520, height: 1180 },
